...
import com.hypto.hws.services.KarthickVinodGrpcKt.KarthickVinodCoroutineStub
import io.grpc.ManagedChannel
import io.grpc.ManagedChannelBuilder
import java.io.Closeable
import java.util.concurrent.TimeUnit

class KarthickVinodClient(private val channel: ManagedChannel) : Closeable {
    private val stub: KarthickVinodCoroutineStub = KarthickVinodCoroutineStub(channel)
...
suspend fun main() {
    val port = 50051
    val address = "karthick-vinod.hypto.com"
    val channel = ManagedChannelBuilder.forAddress(address, port).build()
    val client = KarthickVinodClient(channel)
